...
import { SLEEP_VITAL_METRICS, sleepVitalFilter } from '../metrics/sleep-vitals.js';
...
export const FILTER_FIELDS = {
  ...Object.fromEntries(SLEEP_VITAL_METRICS.map(metric => [metric,sleepVitalFilter(metric)])),
