...
import { createDataInspectorRepository } from './inspector-repository.js';
...
export function createHealthRepository(pool, availabilityOptions = {}) {
  ...
  const inspectorRepository = createDataInspectorRepository(pool, availabilityOptions);
  ...
  return {
    getInspector: inspectorRepository.getInspector,
    getInspectorSource: inspectorRepository.getInspectorSource,
