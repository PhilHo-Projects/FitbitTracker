...
export function createAuth(options = {}) {
  ...
  // PUBLIC_ORIGIN accepts a comma-separated list so one deployment can serve
  // several hostnames. The first entry is the canonical base URL; every entry
  // is trusted for the CSRF and cookie checks.
  const origins = (env.PUBLIC_ORIGIN || '')
    .split(',')
