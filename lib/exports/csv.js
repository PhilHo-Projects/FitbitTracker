...
export const EXPORT_COLUMNS = {
  'daily-summary.csv': [
    ...
    { key: 'oxygenAveragePercentage', label: 'oxygen_average_percentage', unit: 'percent', description: 'Unambiguous provider daily average.' },
    { key: 'oxygenLowerBoundPercentage', label: 'oxygen_lower_bound_percentage', unit: 'percent', description: 'Provider lower confidence bound, not observed minimum.' },
    { key: 'oxygenUpperBoundPercentage', label: 'oxygen_upper_bound_percentage', unit: 'percent', description: 'Provider upper confidence bound, not observed maximum.' },
    { key: 'oxygenSummaryState', label: 'oxygen_summary_state' },
  ],
  'sleep-sessions.csv': [
  ...
  'oxygen-saturation-daily.csv': [
    { key: 'providerKey', label: 'provider_key' },
    { key: 'providerId', label: 'provider_id' },
    { key: 'sourceKey', label: 'source_key', description: 'Reported metadata grouping; not proof of physical device identity.' },
    { key: 'civilDate', label: 'civil_date' },
    { key: 'averagePercentage', label: 'average_percentage', unit: 'percent' },
    { key: 'lowerBoundPercentage', label: 'lower_bound_percentage', unit: 'percent', description: 'Provider confidence lower bound.' },
    { key: 'upperBoundPercentage', label: 'upper_bound_percentage', unit: 'percent', description: 'Provider confidence upper bound.' },
    { key: 'standardDeviationPercentage', label: 'standard_deviation_percentage', unit: 'percent', description: 'Historical deviation across prior daily averages (7–30 days).' },
    { key: 'qualityFlags', label: 'quality_flags' },
  ...
  'oxygen-saturation-samples.csv': [
    ...
    { key: 'civilDate', label: 'civil_date' },
    { key: 'sampledAt', label: 'sampled_at_utc', description: 'Original RFC 3339 physical timestamp, preserving fractional precision and explicit zone.' },
    { key: 'utcOffsetSeconds', label: 'utc_offset_seconds', unit: 'seconds' },
